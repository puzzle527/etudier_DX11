...
void D3d::CreateSwapChainAndDevice()
{
	...
	for (UINT i = 0; i < apapterInfos.size(); ++i)
	{
		if (apapterInfos[i]->AdapterDesc.DedicatedVideoMemory > maxVideoMemory)
		{
			...
			maxVideoMemory = (UINT)apapterInfos[i]->AdapterDesc.DedicatedVideoMemory;
		}
	}
	...
	gpuMemorySize = (UINT)apapterInfos[selected_adapter_index]->AdapterDesc.DedicatedVideoMemory / 1024 / 1024;
